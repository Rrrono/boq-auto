...
class ReviewTask(Base):
    ...
    matched_item_code: Mapped[str] = mapped_column(String(128), default="", nullable=False)
    task_type: Mapped[str] = mapped_column(String(64), default="match_confirmation", nullable=False, index=True)
    task_question: Mapped[str] = mapped_column(Text, default="", nullable=False)
    response_schema_json: Mapped[str] = mapped_column(Text, default="[]", nullable=False)
    ...
    promotion_target: Mapped[str] = mapped_column(String(64), default="", nullable=False)
    promotion_status: Mapped[str] = mapped_column(String(64), default="pending", nullable=False, index=True)
    feedback_action: Mapped[str] = mapped_column(String(32), default="", nullable=False)
    submitted_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    qa_updated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    feedback_logged_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utc_now, nullable=False)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utc_now, nullable=False)
