"""Import plant-focused rate rows into RateLibrary."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Import plant rates into RateLibrary")
    parser.add_argument("--db", required=True)
    parser.add_argument("--input", required=True)
    parser.add_argument("--sheet")
    parser.add_argument("--section", default="Dayworks")
    parser.add_argument("--plant-type", default="plant")
