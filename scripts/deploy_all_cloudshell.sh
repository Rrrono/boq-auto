...
DATABASE_GCS_URI="${DATABASE_GCS_URI:-gs://$BUCKET/runtime/qs_database.xlsx}"
DATABASE_SIDECAR_GCS_URI="${DATABASE_SIDECAR_GCS_URI:-gs://$BUCKET/runtime/qs_database.sqlite}"
...
echo "BUCKET=$BUCKET"
echo "IMAGE=$IMAGE"
echo "DATABASE_GCS_URI=$DATABASE_GCS_URI"
echo "DATABASE_SIDECAR_GCS_URI=$DATABASE_SIDECAR_GCS_URI"
...
if [[ "$DEPLOY_BACKEND" == "true" ]]; then
  ...
  gcloud run deploy "$SERVICE" \
    ...
    --set-env-vars "BOQ_AUTO_GCS_BUCKET=$BUCKET,BOQ_AUTO_API_DB_GCS_URI=$DATABASE_GCS_URI,BOQ_AUTO_API_DB_SIDECAR_GCS_URI=$DATABASE_SIDECAR_GCS_URI,BOQ_AUTO_CLOUD_SQL_CONNECTION_NAME=$CLOUD_SQL_CONNECTION_NAME,BOQ_AUTO_DB_NAME=$DB_NAME,BOQ_AUTO_DB_USER=$DB_USER,BOQ_AUTO_FIREBASE_AUTH_ENABLED=true,BOQ_AUTO_FIREBASE_PROJECT_ID=$PROJECT_ID" \
